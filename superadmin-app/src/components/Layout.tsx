...
export const Layout: React.FC<LayoutProps> = ({ children, title = 'Organizations Manager' }) => {
    ...
    <div className={darkMode ? 'dark' : ''}>
      <div className="h-screen w-screen bg-gray-50 dark:bg-gray-900 flex flex-col transition-colors">
        ...
        <nav className="bg-white dark:bg-gray-800 shadow-sm dark:shadow-md border-b border-gray-200 dark:border-gray-700 flex-shrink-0">
          <div className="px-6 py-4 flex justify-between items-center">
            <div>
              ...
              <p className="text-xs text-gray-600 dark:text-gray-400 mt-0.5">System Administrator</p>
            </div>
        ...
        <main className="flex-1 overflow-y-auto">
          <div className="px-6 py-8 w-full">{children}</div>
        </main>
      </div>
    </div>
  );
